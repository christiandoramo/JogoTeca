...
////////////////////////////////////////////////////
		if (validaCpf && validaEmail && tudoPreenchido) {
			...
			if (uc.cpfJaRegistrado(cpf))
				erros += ("|CPF já registrado| ");
			if (uc.loginJaRegistrado(login))
				erros += ("|login já registrado| ");
			if (uc.cpfJaRegistrado(email))
				erros += ("|email já registrado| ");
			mensagemLabel.setText(erros + "Não foi possivel realizar cadastro!");
		}
	}
	...
	private boolean validarCPF(String cpf) {
		// String cpf é apenas uma copia da outra String cpf
