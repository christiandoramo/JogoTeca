...
public class GamesController {
	...
	public void insertGame(String name, LocalDate releaseDate, Genre genre, String description, String publicadora, String desenvolvedora, Double price, String imageURL, String videoUrl, List<String> imagesUrl) throws ElementAlreadyExistsException, ElementWithSameNameExistsException {
		Game novo = new Game(lastId+1, name, releaseDate, genre, description, publicadora, desenvolvedora,price,imageURL,videoUrl,imagesUrl);
