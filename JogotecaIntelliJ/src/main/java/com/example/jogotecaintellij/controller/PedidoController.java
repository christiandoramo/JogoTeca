...
public class PedidoController {
	...
	public void adicionarPedido(LocalDateTime momento, List<GameItem> itens, User user)
	...
	public Pedido buscarPelouser(User user) throws ElementDoesNotExistException {
		return pedidoRepositorio.read().stream().filter(pedido -> pedido.getUser().equals(user)).findFirst()
				.orElse(null);
	}
	...
	public void updatePedidoById(int id, LocalDateTime momento, List<GameItem> itens, User user)
