...
public class ComprovanteController extends AccessAreaController implements Initializable {
    @FXML
    protected Text cpf;
    ...
    void carregarComprovante(Venda venda) {
        ...
        String _metodo = venda.getPedido().getMetodoPagamento().name();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        carregarComprovante(AccessAreaController.vendaAtual);
    }
}
