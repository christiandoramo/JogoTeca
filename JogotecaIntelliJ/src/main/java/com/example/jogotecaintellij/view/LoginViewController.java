...
public class LoginViewController extends AccessAreaController implements Initializable {
    ...
    public void handleLoginButtonAction() {
        ...
        // implementar l�gica de autentica��o
        
        // mostrar mensagem de erro caso ocorra
        errorMessageLabel.setText("Usu�rio ou senha inv�lidos");
