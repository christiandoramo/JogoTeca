...
public class PedidoController {
	...
	public Pedido buscarPeloUsuario(Usuario usuario) throws ElementDoesNotExistException {
		return pedidoRepositorio.read().stream().filter(pedido -> pedido.getUsuario().equals(usuario)).findFirst()
				.orElse(null);
	}
	...
	public void updatePedidoById(int id, LocalDateTime momento, List<GameItem> itens, Usuario usuario)
